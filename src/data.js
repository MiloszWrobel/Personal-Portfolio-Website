...
import ffLogo from "./assets/funky-friday-logo.png";
...
export default [
  {
    ...
    Initially, this website originated from a React course that I've been actively studying. However, once I finished programming the website, I took it upon myself to continue working on it. Originally, the game was only playable with two players, and there was no AI mode.
    
    Naturally, I thought to myself that that was the next step I should take when working on a game such as this.
    
    Users can select their preferred mode from a Menu component, which provides options for the two-player mode or an AI opponent. For the AI games, players can choose from three difficulty levels: easy, medium, and hard, which adjust the AI's decision-making strategy.
